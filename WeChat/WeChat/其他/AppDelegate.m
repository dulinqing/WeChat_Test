...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MytabbarViewController *tabar=[[MytabbarViewController alloc]init];
    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"logined"]  isEqual: @(1)]) {
        _window.rootViewController=tabar;
    }else{
    _window.rootViewController=loginV;
    }
